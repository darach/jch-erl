...
perf: test
	clang -c -O3 -ffast-math -m64 -std=c99 -I c_src perf/ch.c -o perf/ch.o
	clang -o perf/ch c_src/jch.o perf/ch.o -lm
	perf/ch 10000000 10
	...
	ERL_LIBS=deps perf record erl +sfwi 1 +scl false -pa ebin -pa perf -noinput -eval "bench:main([])"
